...
\newcommand{\powset}[1][X]{\mathcal{P}\pbraces{#1}}

\newcommand{\Top}{\mathbf{Top}}
\newcommand{\Met}{\mathbf{Met}}
\newcommand{\Haus}{\mathbf{Haus}}
\newcommand{\Normal}{\mathbf{T4}}
...
\NewDocumentCommand
{\prodtspace}
{ O{X} O{T} O{\bbraces{0, 1}} O{\eucl}}
{\pbraces{#1 \times #3, \mathcal{#2} \times #4}}
...
\newcommand{\aexs}{absolute extensors}
\newcommand{\ar}{absolute retract}
\newcommand{\ars}{absolute retracts}
\newcommand{\ane}{absolute neighborhood extensor}
\newcommand{\anes}{absolute neighborhood extensors}
\newcommand{\anr}{absolute neighborhood retract}
\newcommand{\anrs}{absolute neighborhood retracts}
...
\newcommand{\clo}[2][T]{\mathrm{cl}_\mathcal{#1}\bbraces{#2}}
\DeclareMathOperator{\supp}{supp}
\DeclareMathOperator{\conv}{co}
\DeclareMathOperator{\ran}{ran}

\newcommand{\eucl}[1][\bbraces{0,1}]{\pbraces{#1, \mathcal{E}}}
