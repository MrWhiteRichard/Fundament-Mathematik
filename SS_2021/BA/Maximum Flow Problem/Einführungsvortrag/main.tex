...
\begin{frame}{Definitionen (2/2)}
  ...
  \begin{tikzpicture}[
      ...
      \node[mycircle, onslide=<1>{violet}] (s) {$s$};
      \node[mycircle,above right=of s, onslide=<1>{violet}] (v1) {$v_1$};
      \node[mycircle,below right=of s, onslide=<1>{violet}] (v2) {$v_2$};
      \node[mycircle,above right=of v2, onslide=<1>{olive}] (t) {$t$};
    ...
    \draw [myarrow, onslide=<1>{highlight}] (v1) -- node[sloped,font=\small,above] {1} (t);
    \draw [myarrow, onslide=<1>{highlight}] (v2) -- node[sloped,font=\small,below] {2} (t);
  ...
  \subfloat[$w(f_1) = 3$]{
    \begin{tikzpicture}[
      ...
      \draw [myarrow] (s) -- node[sloped,font=\small,above, onslide=<1>{green}] {(2/2)} (v1);
      \draw [myarrow] (s) -- node[sloped,font=\small,below] {(1/1)} (v2);
      \draw [myarrow] (v1) -- node[sloped,font=\small,above] {(1/1)} (t);
      \draw [myarrow] (v2) -- node[sloped,font=\small,below, onslide=<1>{green}] {(2/2)} (t);
      \draw [myarrow] (v2.70) -- node[sloped,font=\small,below, onslide=<1>{red}] {(0/1)} (v1.290);
      \draw [myarrow] (v1.250) -- node[sloped,font=\small,above,rotate=180] {(1/1)} (v2.110);
  ...
  \begin{tikzpicture}[
      ...
      \node[below=0cm of v5, visible on=<11-12>, font=\small] {$(v_4, +, 9)$};
