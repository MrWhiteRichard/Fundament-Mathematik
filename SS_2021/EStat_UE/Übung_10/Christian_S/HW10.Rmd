...
\quad (iv) We can only say that at least half of the running times in B were faster than $3/4$ of the running  times in A.

\quad (v) True 

\quad (vi) We can not answer this with only the graphic.
