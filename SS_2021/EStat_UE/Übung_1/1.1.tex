    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw (0, 0) node [above] {$r_1$};
                \draw (0, 0) -- node [above left] {$\nfrac{3}{51}$} (-4, -1) node [above left] {$r_1 = r_2$};
                    \draw (-4, -1) -- node [above left]  {$\nfrac{2}{50}$}  (-6, -2) node [below] {$r_1 = r_2 = r_3 = r_1$};
                    \draw (-4, -1) -- node [above right] {$\nfrac{48}{50}$} (-2, -2) node [below] {$r_1 = r_2 \neq r_3 \neq r_1$};
                \draw (0, 0) -- node [above left] {$\nfrac{48}{51}$} (4, -1) node [above right] {$r_1 \neq r_2$};
                    \draw (4, -1) -- node [above left]  {$\nfrac{3}{50}$}  (2, -2) node [below] {$r_1 \neq r_2 \neq r_3 = r_1$};
                    \draw (4, -1) -- node [below right] {$\nfrac{3}{50}$}  (4, -4) node [below] {$r_1 \neq r_2 = r_3 \neq r_1$};
                    \draw (4, -1) -- node [above right] {$\nfrac{44}{50}$} (6, -2) node [below] {$r_1 \neq r_2 \neq r_3 \neq r_1$};
