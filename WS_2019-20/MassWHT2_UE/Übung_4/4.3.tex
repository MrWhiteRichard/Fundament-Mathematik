...
Zeigen Sie, dass diese \Quote{nichttrivialen Homomorphismen} auf jedem nichtleeren Intervall unbeschränkt sind, also dass jede additive Funktion linear ist, wenn es ein nichtleeres Intervall gibt, auf dem sie beschränkt ist.
