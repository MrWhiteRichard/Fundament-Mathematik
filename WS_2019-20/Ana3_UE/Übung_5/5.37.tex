...
Zeigen Sie $\hat f(l) = a_{|l|}$ und begründen Sie damit, dass das Riemann-Lebesgue-Lemma in dem Sinn nicht verschärft werden kann, dass die Folge der Fourierkoeffizienten \Quote{beliebig langsam} gegen $0$ konvergieren kann (d.h. für jedes $\alpha > 0$ gibt es $f \in L^1$ mit $\limsup \hat f(n) h^\alpha > 0$).
