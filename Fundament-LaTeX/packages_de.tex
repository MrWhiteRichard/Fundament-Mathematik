...
% Support for using RSFS fonts in math
\usepackage{mathrsfs}
...
% Re-implementation of and extensions to LATEX verbatim
\usepackage{verbatim}
...
% Figures broken into sub-figures
\usepackage{subfig}
...
% Colored boxes, for LATEX examples and theorems, etc
