...
Wenn man dann das, in \eqref{eq_1} beschriebene, \Quote{Kreuzprodukt} analog bildet, so erhält man abermals einen Vektor $b$, welcher orthogonal (bzgl. dem kanonischen Skalarprodukt) auf $a$ steht.
