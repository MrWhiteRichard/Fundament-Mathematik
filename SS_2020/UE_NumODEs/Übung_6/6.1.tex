...
\begin{enumerate}[label = \textbf{\alph*)}]
  ...
  \begin{align*}
    ...
    &\iff \frac{c_2^2 + c_2(2 - 3c_2)}{6c_2(1 - c_2)} \stackrel{!}{=} \frac{1}{2} \\
    &\iff \frac{2c_2 - 2c_2^2}{6c_2(1 - c_2)} \stackrel{!}{=} \frac{1}{2} \\
    &\iff c_2 \notin \{0,1\}  \\
    Q(x^3) &= \frac{c_2^3}{6c_2(1 - c_2)} +
    \frac{2- 3c_2}{6(1 - c_2)} \stackrel{!}{=} \frac{1}{4} \\
    &\iff \frac{c_2^3 + c_2(2 - 3c_2)}{6c_2(1 - c_2)} \stackrel{!}{=} \frac{1}{2} \\
    &\iff \frac{c_2^2 - 3c_2 + 2}{6(1 - c_2)} \stackrel{!}{=} \frac{1}{2} \\
    &\iff 2c_2^2 - 6c_2 + 4 \stackrel{!}{=} 6(1 - c_2)\\
    &\iff 2c_2^2 - 2 \stackrel{!}{=} 0\\
    &\iff c_2 \in \{-\frac{1}{2},\frac{1}{2}\} \\
  \end{align*}
