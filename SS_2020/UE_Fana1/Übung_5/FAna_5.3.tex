...
\begin{solution}
  ...
  \begin{itemize}
       ...
       ***Alternativ (und ohne Dualräume)
       Die Hilbertraumadjungierte $S^*$ ist charakterisiert durch
       \begin{align*}
          (Sx,y) = (x,S^*y) \text{~für alle~} x \in \ell^2(\N) \\
          \Rightarrow 0 + \sum_{n=2}^{\infty}x_{n-1} \overline{y_n} = \sum_{n=1}^{\infty}x_n \overline{y_{n+1}} \stackrel{!}{=} \sum_{n=1}^{\infty}x_n \overline{(S^*y)_n}
       \end{align*}
      ...
      Sei dazu $(x_k)_{k=0}^\infty \in \ell^2$ beliebig. Wir konstruieren eine weitere Folge $(y_k)_{k=0}^\infty \in \ell^2,$ die
      $(S^*)^n((y_k)_{k=0}^\infty) = (x_k)_{k=0}^\infty$ erfüllt, wie folgt:
      \begin{align*}
