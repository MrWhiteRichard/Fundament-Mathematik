...
\end{align*} 
linear mit $\bigcap_{j \in J_k} \ker R_{kj} = 0$ und gemäß Bemerkung 5.1.6 ist
\begin{align*}
...
\end{align*}
ein Homöomorphismus und $\mathcal{T}_k$ die initiale Topologie bezüglich der $(R_{kj})_{j \in J_k}$.
