...
und $(u_i)_{i \in J}$ mit $J \subset I$ eine ONB von $E(B_r)$.
...
Für alle $u_j,j \in J$ gilt nun
\begin{align*}
  \|AA^*u_j\|^2 &= (AA^*u_j,AA^*u_j) = \int_{\C}|\phi|^2 dE_{u_j,AA^*u_j} \geq \int_{B_r}r^2 dE_{u_j,AA^*u_j} = r^2(E(B_r)u_j,AA^*x) = r(u_j,AA^*u_j)
  \\
  &= r(AA^*u_j,u_j) = r\int_{\C}|\phi|^2 dE_{u_j,u_j} \geq r^4(E(B_r)u_j,u_j) = r^4(u_j,u_j) = r^4\|u_j\|^2.
\end{align*}
Damit gilt: Der zugehörige Eigenwert zu $u_j$ muss größer gleich $r^2$ sein und es folgt
\begin{align*}
  \dim(\ran(\bigoplus_{k \in \N: |\lambda_k| \geq r^2}P_k)) \geq \dim(\ran(E(B_r))) = \infty.
\end{align*}
