...
\begin{enumerate}[label = (\roman*)]
  ...
  Die Voraussetzung, $A(X)$ sei von 2. Kategorie besagt, dass sich $A(X)$ nicht als abzählbare Vereinigung von \Quote{nirgends dichten} Mengen darstellen lässt.
  Also, soll eine der Mengen, in der oberen Vereinigung, nicht \Quote{nirgends dicht} sein.
  D.h. $\Exists k \in \N:$
