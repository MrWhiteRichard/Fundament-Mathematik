...
(a) \blockquote{$\geq$}: Sei $A \subseteq \Omega$, dann folgt die eine Ungleichung wegen \\
...
\blockquote{$\leq$}: Für die Andere, finden wir für beliebiges $\epsilon > 0$ zwei disjunkte Überdeckungen $(B_n), (C_m) \in \mathfrak{R}$ von $A$, sodass
