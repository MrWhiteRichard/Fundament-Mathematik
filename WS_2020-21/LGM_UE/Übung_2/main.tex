...
Eine Menge $\Sigma$ von aussagenlogischen Formeln heißt \Quote{erfüllbar}, wenn es eine Belegung oder in $\Sigma$ vorkommenden Variablen gibt, die für alle $A \in \Sigma$ die Bedingung $\hat{b}(A) = 1$ erfüllt.
