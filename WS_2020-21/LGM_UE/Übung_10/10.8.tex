...
\phantom{}
	...
	\begin{enumerate}[label = \arabic*.]
		...
		\item Primzahlen $P$: Sei $\varphi$ eine Formel, für die $\mathrm{Mod}(\varphi)$ die Klasse aller Körper ist. Weiters veralngen wir, dass es höchstens einen Automorphismus gibt. Vergleich dazu Algebra Skriptum Proposition 6.3.3.2. 
