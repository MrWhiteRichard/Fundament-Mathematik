...
\begin{enumerate}[label = (\roman*)]
    ...
    Jetzt multiplizieren wir mit $r^2 v_n(R)$ und \blockquote{stoßen} auf eine \blockquote{eulersche Differentialgleichung 2. Ordnung}.
    ...
    Unsere \blockquote{beliebige Quelle} an der Stelle ist (NATÜRLICH, was sonst?) Wikipedia!
    ...
    \begin{enumerate}
        ...
        \item \blockquote{$\pi < \varphi < 2 \pi$}:
        \begin{align*}
            w_3(\varphi)
            =
...
\begin{enumerate}[label = (\roman*)]
    ...
    \begin{itemize}
        ...
        \item \blockquote{Randbedingung}:
        Das folgt unmittelbar aus der \blockquote{Wahl} der Fourierkoeffizienten.
