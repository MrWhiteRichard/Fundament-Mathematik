...
\begin{enumerate}[label = (\roman*)]
    ...
    Jetzt multiplizieren wir mit $r^2 v_n(R)$ und \enquote{stoßen} auf eine \enquote{eulersche Differentialgleichung 2. Ordnung}.
    ...
    Unsere \enquote{beliebige Quelle} an der Stelle ist (NATÜRLICH, was sonst?) Wikipedia!
