...
(Das ist in Wahrheit eine Zusammenfassung der \enquote{Variation der Konstanten}.)
...
Das funktioniert, laut dem \enquote{Hauptsatz über implizite Funktionen} bzw. \enquote{Umkehrsatz} bzw. Skriptum (bzw. Vorlesung), $\Forall t \neq 0:$
