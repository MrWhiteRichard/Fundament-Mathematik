...
(Das ist in Wahrheit eine Zusammenfassung der \blockquote{Variation der Konstanten}.)
...
Das funktioniert, laut dem \blockquote{Hauptsatz über implizite Funktionen} bzw. \blockquote{Umkehrsatz} bzw. Skriptum (bzw. Vorlesung), $\Forall t \neq 0:$
