...
\begin{align*}
\lim_{l \to \infty} \sup_{x\in\Omega} \vbraces{D^\alpha \pbraces{\phi(x) - \psi_l(x)}} = \lim_{l \to \infty} \sup_{x\in\Omega} \vbraces{D^\alpha \sum_{k=l}^\infty \zeta_k(x)\phi(x) - D^\alpha \psi_l(x)} = \lim_{l \to \infty} \sup_{x\in\Omega} \vbraces{\sum_{k=l+1}^\infty \zeta_k(x)D^\alpha \phi(x)} = 0.
\end{align*}
