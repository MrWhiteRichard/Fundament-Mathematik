...
\begin{enumerate}[label = (\roman*)]
  ...
  &= (C_2-C_1)\exp(0)\phi(0) = (C_2 - C_1)\langle \delta, \phi \rangle
  \end{align*}
  Für $C_2 - C_1 = 1$ ist also $U_0$ eine Fundamentallösung
  an der Polstelle $0$. Wählen wir also der Einfachheit halber $C_2 = 1$ und $C_1 = 0$, dann erhalten wir
  \begin{align*}
