...
\begin{enumerate}[label = (\roman*)]
  ...
  Aus der Analysis wissen wir, dass $\{\cos(nx): n \in \N\} \cup \{\sin(nx): n \in \N^{+}\}$ eine vollständiges Orthonormalsystem vom $L^2(-\pi, \pi)$ ist.
  ...
  \begin{align*}
    \tilde{f} = \sum_{n=0}^{\infty} (\tilde{f}, \cos(nx))_{L^2(- \pi,\pi)} \cos(nx) + \sum_{n=1}^{\infty} (\tilde{f}, \sin(nx))_{L^2(-\pi, \pi)} \sin(nx)
  \end{align*}
  ...
  \begin{align*}
    f = \sum_{n=1}^{\infty} ({f}, \sqrt{2} \sin(nx))_{L^2(0, \pi)} \sqrt{2} \sin(nx)
  \end{align*}

  und somit $\{\sqrt{2} \sin(nx): n \in \N^{+}\}$ eine Orthonormalbasis ist. Daraus kann man vermutlich zeigen, dass auch unser Orthonormalsystem $\{\sqrt{\frac{2}{\pi}} \sin(\frac{2n-1}{2}x): n \in \N^{+}\}$ vollständig ist - darauf müssen wir an dieser Stelle leider verzichten.
