...
\begin{solution}
	...
	\begin{enumerate}[label = (\roman*)]
		\item Wir betrachten das Fouriertransformierte Anfangswertproblem
			...
			&= (2 \pi)^{-n} t^{-\frac{n}{2}} \mathrm{e}^{i\frac{|x|^2}{4t}} \prod_{j = 1}^n 2 \pbraces{\underbrace{\Int[\R^+][]{\cos\pbraces{u_j^2}}{u_j}}_{= \frac{\sqrt{2\pi}}{4}} - i \underbrace{\Int[\R^+][]{\sin\pbraces{u_j^2}}{u_j}}_{= \frac{\sqrt{2\pi}}{4}}} \\
			&= (2 \pi)^{-n} t^{-\frac{n}{2}} \mathrm{e}^{i\frac{|x|^2}{4t}} \prod_{j = 1}^n 2\frac{2\sqrt{\pi}}{4} \pbraces{ \frac{1}{\sqrt{2}} - i\frac{1}{\sqrt{2}} } \\
			&= (2 \pi)^{-n} t^{-\frac{n}{2}} \mathrm{e}^{i\frac{|x|^2}{4t}} \pi^{\frac{n}{2}} \mathrm{e}^{-i n \frac{\pi}{4}} = (4 i \pi t)^{-\frac{n}{2}} \mathrm{e}^{i\frac{|x|^2}{4t}}
			\end{align*}
      Damit erhalten wir schließlich unsere Darstellung
      \begin{align*}
        u(x,t) = (4 i \pi t)^{-\frac{n}{2}} \int_{\R^n} \mathrm{e}^{i\frac{|x-y|^2}{4t}}f(y) dy
      \end{align*}
