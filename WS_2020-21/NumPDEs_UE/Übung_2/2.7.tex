...
\begin{enumerate}[label = \textbf{\alph*)}]
  ...
  \begin{align*}
    ...
    &\leq \sqrt{\sum_{|n| > N}\|(f, \phi_n)_{H^1(\Omega)}\|_{H^1(\Omega)}^2 \sum_{|n| > N}\|\phi_n\|_{L^2(\Omega)}^2}
  \end{align*}
  Weiters gilt mit
  ...
  \begin{align*}
  \sqrt{\sum_{|n| > N}\|(f, \phi_n)_{H^1(\Omega)}\|_{H^1(\Omega)}^2 \sum_{|n| > N}\|\phi_n\|_{L^2(\Omega)}^2}
