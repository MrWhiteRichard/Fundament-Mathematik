...
\begin{enumerate}[label = \arabic*]
  ...
  \item Corollary 3.6 \dots \Quote{Approximation Theorem für $\mathcal{S}_D^1$ und $\mathcal{S}_\ast^1$}
  \item Lemma 3.7 (Bramble-Hilbert)
  \item Lemma 3.8 (Transformation Formula)
  \item Lemma 3.9 \dots \Quote{Referenz-Dreieck-Transformation und deren geometrische Interpretation}
\end{enumerate}
