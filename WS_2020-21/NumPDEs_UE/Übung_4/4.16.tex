...
\begin{enumerate}[label = \textbf{\alph*)}]
  ...
  \begin{align*}
    ...
    &= \sum_{T \in \mathcal{T}}\|I_{h,p}u|_T\|_{L^2(T)}^2
    = \sum_{T \in \mathcal{T}}\int_T (\hat{I_p}(u \circ \Phi_T) \circ \Phi_T^{-1})^2 dx \\
    &= \sum_{T \in \mathcal{T}}\int_{T_{\mathrm{ref}}}
    (\hat{I_p}(u \circ \Phi_T))^2 |\det(B_T)|dx \\
    &= \sum_{T \in \mathcal{T}}|\det(B_T)|\|\hat{I_p}(u \circ \Phi_T)\|_{L^2(T_{\mathrm{ref}})}^2 dx \\
    &\leq \sum_{T \in \mathcal{T}}
    |\det(B_T)|C_{\mathrm{norm}}^2\left(\max_{z \in Z_p}|\hat{I_p}(u \circ \Phi_T)(z)|\right)^2 \\
    &\leq C_{\mathrm{norm}}^2\sum_{T \in \mathcal{T}}2|T|\|u\|_{C(T)}^2
    \leq 2|\Omega|C_{\mathrm{norm}}^2C_{\mathrm{sobolev}}^2\sum_{T \in \mathcal{T}}\|u\|_{H^2(T)}^2 \\
    &\leq 2|\Omega|C_{\mathrm{norm}}^2C_{\mathrm{sobolev}}^2\|u\|_{H^2(\Omega)}^2 \\
  \end{align*}
