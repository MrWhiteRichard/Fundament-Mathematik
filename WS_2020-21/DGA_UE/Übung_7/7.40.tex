...
\begin{enumerate}[label = \alph*]
    ...
    \item Wir diskutieren die Schritte und Ergebnisse des Algorithmus von Dijkstra im $((0, 1), \cdot)$-Setting.
    Genau genommen operiert dieser im isomorphen $((0, \infty), +)$-Setting.
