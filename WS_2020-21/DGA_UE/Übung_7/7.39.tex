...
\begin{enumerate}[label = (\Alph*)]
    ...
    \begin{enumerate}
    	...
    	\item Wenn eine Kante $e_{i_j}$ aus dem Zykel $e_{i_1}, \dots, e_{i_k}$ gelöscht wird und diese in dem Zykel die größten (das heißt alle andern sind echt kleiner) Kosten hat, dann kann $e_{i_j}$ in keinem minimalen Spannbaum vorkommen. Denn wäre $e_{i_j} \in S$ und $(V, S)$ ein minimaler Spannbaum, dann könnte ich $e_{i_j}$ durch eine aus $S$ löschen und dafür eine entpsrechende andere Kante aus dem Zykel so hinzufügen, dass ich wieder einen Spannbaum erhlatem, dieser hat kleinere Kosten, ein Widerspruch. 
    	
    	Wenn eine Kante aus einem Zykel gelöscht wird, in dem es keine eindeutig maximalen kosten gibt, dann ??? 
    \end{enumerate}
