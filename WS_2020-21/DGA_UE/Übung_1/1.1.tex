...
\begin{enumerate}[label = (\alph*)]
  ...
  Im worst-case ist die Liste absteigend sortiert.
  Die Bedingung in der $6$-ten Zeile hält also stets und
  ...
  \begin{multline*}
    ...
    =
    1 + \sum_{i=1}^{n-1} 3 + \sum_{i=1}^n 3n - \sum_{i=1}^n 3i \\
    =
    1 + 3 (n - 1) + 3n^2 - 3 \frac{n (n + 1)}{2}
    =
  ...
  Im worst-case ist die Liste aufsteigend sortiert.
