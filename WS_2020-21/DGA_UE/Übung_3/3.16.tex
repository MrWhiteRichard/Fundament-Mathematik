...
\begin{enumerate}[label = \alph*.]
  ...
  4&: \quad \textbf{Sonst} \\
  5&: \quad \quad \textbf{Antworte } \textsc{Matrix Potenzieren} \pbraces{M, \floorbraces{\frac{n}{2}}} \cdot \textsc{Matrix Potenzieren} \pbraces{M, \ceilbraces{\frac{n}{2}}} \\
  ...
  Man gewinnt durch das \Quote{teilen und herrschen} hier leider Nichts.
