...
Für $i = 1, \dots, 2k$, ergänzen wir $G_i^\prime$ um den Knoten $v$ und Kante $\Bbraces{x_i, v}$ zum \enquote{Ast} $G_i$. \\
...
\enquote{$G \setminus G_i}$ hat dann eine ungerade Kanten-Zahl, weil \enquote{$G = G_i + G \setminus G_i$} ja eine ungerade Kanten-Zahl hat. \\
...
Wir finden einen solchen Teilgraphen (\enquote{Spannbaum}) $G_0 = (V, E_0)$ mit $E_0 \subseteq E$.
