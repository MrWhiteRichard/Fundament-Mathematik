...
\end{array}\right)$
		...
		\EndFor
	\end{algorithmic}
	\algorithmicensure{ $A$ wird mit oberer Dreiecksmatrix ($=R$) überschrieben, $B$ ist das Produkt der Givens-Rotationen und $Q = B^*$ ist die gewünschte unitäre Matrix}
\end{algorithm}
...
\begin{figure}[H]
  \centering
  \subfloat[][uniform Verteilte Eigenwerte]{\includegraphics[width=0.45\linewidth]{Plots/error_arnoldi_uniform}}%
  \qquad
