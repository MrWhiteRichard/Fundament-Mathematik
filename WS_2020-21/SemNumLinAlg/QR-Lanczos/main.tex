...
Die Einträge konvergieren schneller gegen $0$, wenn der Bruch kleiner ist. Wir versuchen das zu erreichen, indem wir einen Shift durchführen. Für einen Eigenwert $\lambda$ einer Matrix $A$ gilt
...
\begin{lemma}
	Sei $[a,b]$ ein nicht-leeres Intervall in $\R$ und sei $c \geq b$. Dann gilt mit $\gamma := 1 + 2 (c-b)/(b-a) \geq 1$
