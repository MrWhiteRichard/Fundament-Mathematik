...
\begin{theorem}[Konvergenz der Eigenwerte hermitescher Matrizen]
	...
	Dabei gilt die dritte Gleichheit, da $V$ als Abbildung von $\C^m$ nach $\mathcal{K}_m$ bijektiv ist. Also kann jeder $k$-dimensionale Unterraum $T \subseteq \mathcal{K}_m$ als $V(S)$ gesehen werden, wobei $S$ ein $k$-dimensionaler Unterraum von $\C^m$ ist. 
