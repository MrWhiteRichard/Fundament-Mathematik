...
\begin{theorem}[Konvergenz der Eigenwerte hermitscher Matrizen]
	...
	Bezeichne mit $u_j^{(m)} \in \C^m, \, j = 1,\dots, m$ die Eigenvektoren zu den Eigenwerten $\lambda_j^{(m)} , \, j = 1,\dots, m$ der Abbildung $T_m$. Mit \ref{lambdamax} erhalten wir dann
