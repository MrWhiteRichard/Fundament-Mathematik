...
Als Toleranz zur Bestimmung der \Quote{korrekten} Singulärwerte wählen wir $\texttt{tol} = 10^{-5}$.
...
Wie man in Abbildung \ref{fig:plot1} sieht, befinden sich die, von unserem Algorithmus als \Quote{korrekt} identifizierten, Eigenwerte alle innerhalb unserer Konturintegralkurve, während die zusätzlichen Werte außerhalb liegen.
...
\input{Kapitel/5/sect - Cut-Off.tex}
\input{Kapitel/5/sect - Pitfalls.tex}
