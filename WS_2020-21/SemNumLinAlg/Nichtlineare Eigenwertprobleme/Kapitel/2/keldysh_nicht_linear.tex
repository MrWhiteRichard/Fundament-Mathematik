\begin{theorem}[Keldysh, nicht-linear] \label{keldysh_nicht_linear}
    ...
    \begin{align*}
        \Forall l = 1, \dots, L_1: A^\prime(\lambda_1) v_{1, l}
        \not \in
        \ran A(\lambda_1).
    \end{align*}

    Dann existiert eine Basis $w_{1, 1}, \dots, w_{1, L_1}$ von $\ker A^\ast(\lambda_1)$, sodass

    \begin{align}
        \Forall l, k = 1, \dots, L_1: w_{1, l}^\ast A^\prime(\lambda_1) v_{1, k} = \delta_{l, k}.
    \end{align}
