\begin{proof}[Beweis (zu Fuß)]
    ...
    \begin{enumerate}[label = (\roman*)]
        ...
        Dabei ist $X := \ker P_1^-$ so wie in \ref{spektrale_projektion}.
        ...
        Für $\lambda \in U_1 \setminus \Bbraces{\lambda_1}$ ist $R(\lambda)$ wohldefiniert, weil $\lambda$ kein Eigenwert und somit $\ker(A - I_N \lambda) = 0$, also $A - I_N \lambda$ invertierbar ist.
        Weil $A$ in $\lambda$ holomorph ist, so auch $A - I_N \id$.
        Wegen der Kofaktor-Darstellung der Inversen, als Matrix mit komponentenweise rationalen Polynomen, ist $(A - I_N \id)^{-1}$, und somit $R$, in $\lambda$ holomorph.

        Dies soll nun auch für $\lambda_1$ gelten.
        Laut Bemerkung \ref{semi_inverse}, ist $R_1(\lambda_1)$ (insbesondere die Inverse) wohldefiniert.
        ...
        $(I_N - P_1^-) x \in X$ und $(A - I_N \lambda_1) |_X^{-1}$ ist $X$-invariant, also $y \in \Lin(\C^N, X)$.
        ...
        \begin{align*}
            \norm{(A - I_N \lambda)^{-1} y}
            & \leq
            \norm{(A - I_N \lambda_1) |_X^{-1} y}
            +
            \norm
            {
                (A - I_N \lambda)^{-1} y
